...
import ProjectGroupDescription from "./ProjectGroupDescription"
...
export default function ProjectGroup({ title, desc, descMd, glyph, cards, stack }: ProjectGroupProps) {
    return (
        <div className="project-group">
            <div className="project-group__header">
                ...
                <div className="project-group__meta">
                    ...
                    {descMd ? (
                        <div className="project-group__desc">
                            <ProjectGroupDescription source={descMd} />
                        </div>
                    ) : desc ? (
                        <p className="project-group__desc">{desc}</p>
                    ) : null}
